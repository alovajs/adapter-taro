...
import { mockStorageContainer, taroDownloadConfig, taroRequestConfig, taroUploadConfig } from './utils';
...
taroMockMap;
// global.Taro = (window as any).Taro = taroMockMap;
